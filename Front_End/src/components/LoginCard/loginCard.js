    ...
    return (
        <form className="auth-card" onSubmit={handleSubmit}>
            ...
            <div style={{ textALign: 'left', marginTop: '-8px', marginBottom: '16px' }}>
                <a href="#" style={{ color: 'var(--text-main-color)', fontSize: '14px', textDecoration: 'underline' }}>
                    Esqueci a senha
                </a>
            </div>
            ...
            {/* Separador e Link Criar conta */}
            <div style={{ position: 'relative', marginTop: '24px', textAlign: 'center' }}>
                <div style={{ borderTop: '1px solid var(--text-main-color)', width: '100%' }}></div>
                <span style={{
                    position: 'absolute',
                    top: '-10px',
                    left: '50%',
